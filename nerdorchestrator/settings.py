"""
Django settings for nerdorchestrator project.
...
SECRET_KEY = 'b^6nn*+9(id9!us0wl+(dh%+*m+cy4_klr(uiksiqql7)d4nnj'
...
ROOT_URLCONF = 'nerdorchestrator.urls'
...
WSGI_APPLICATION = 'nerdorchestrator.wsgi.application'
